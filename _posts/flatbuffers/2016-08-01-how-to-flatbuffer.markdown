...
Lets build Netflix!  All of the code I'll be building here are found in my [flatbuffers-benchmarks](https://github.com/michaelbpaulson/flatbuffers-benchmarks) repo.  For the sake of readability, I'll reduce the amount of code to a minimal amount.  For more examples of schema's and usage check out the test directory of [Google FlatBuffers](https://github.com/google/flatbuffers).
